...
/**
 * Handler/Orchestration for getProduct.
 */
@Component
public class GetProductHandler extends AbstractHandler<GetProductRequest, GetProductResponse> {
  private final GetProductRequestValidator getProductRequestValidator;
  private final GetProductFailureResponseMapper getProductFailureResponseMapper;
  private final ProductRepository productRepository;
  private final GetProductResponseMapper getProductResponseMapper;
   ...
   */
  @Autowired
  public GetProductHandler(final GetProductRequestValidator getProductRequestValidator,
